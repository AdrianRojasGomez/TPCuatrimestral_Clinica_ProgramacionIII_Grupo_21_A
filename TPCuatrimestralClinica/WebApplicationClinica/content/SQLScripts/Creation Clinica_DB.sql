...
-- 2. TABLA DE USUARIOS (Como la tenías)
CREATE TABLE UsuariosApp (
    IdUsuario INT IDENTITY(1,1) PRIMARY KEY,
    NombreUsuario VARCHAR(50) NOT NULL,
    Clave VARCHAR(50) NOT NULL,
    TipoUusario INT NOT NULL -- Nota: El nombre original 'TipoUusario' se mantiene
);
GO
...
VALUES
('admin', '1234', 1),          -- 1 = Administrador
('medico1', 'med123', 2),      -- 2 = Médico
('recepcion1', 'rec123', 3),   -- 3 = Recepcionista
('prueba', 'pass', 2),         -- 2 = Médico
('usuario', 'clave', 3);       -- 3 = Recepcionista
GO
...
INSERT INTO Pacientes (Dni, Apellido, Nombre, FechaNacimiento, Email, Telefono, Direccion)
VALUES
('30111222', 'García', 'Juan', '1985-03-15', 'juan.garcia@email.com', '11-5555-1234', 'Av. Siempre Viva 123'),
('32222333', 'Martinez', 'Maria', '1990-07-20', 'maria.martinez@email.com', '11-5555-5678', 'Calle Falsa 456'),
('28333444', 'Lopez', 'Carlos', '1980-11-01', 'carlos.lopez@email.com', '11-5555-9012', 'Boulevard de los Sueños 789'),
('35444555', 'Rodriguez', 'Ana', '1995-01-30', 'ana.rodriguez@email.com', '11-5555-3456', 'Pasaje del Sol 101'),
('38555666', 'Perez', 'Laura', '2000-05-10', 'laura.perez@email.com', '11-5555-7890', 'Rivadavia 2030');
GO
...
VALUES
('Martín', 'Gonzalez', 'MN-1001'),  -- ID 1
('Lucía', 'Fernandez', 'MN-1002'), -- ID 2
('Diego', 'Alvarez', 'MP-2001'),   -- ID 3
('Valeria', 'Ruiz', 'MP-2002');    -- ID 4
GO
...
    NumeroTurno INT NOT NULL, -- Asumo que esto puede ser un nro diario (ej: 1, 2, 3...)
...
    Estado BIT NOT NULL, -- 0 = Pendiente, 1 = Completado
    
    -- *** VALIDACIÓN: Agregadas FOREIGN KEYS ***
...
INSERT INTO Turnos (NumeroTurno, FechaInicio, FechaFin, HoraInicio, HoraFin, ObservacionesSolicitud, ObservacionesDiagnostico, IdMedico, IdPaciente, Motivo, Estado)
VALUES
-- Turno 1: Paciente 1 (Garcia) con Medico 1 (Gonzalez - Cardio)
(1, DATEADD(day, 1, CAST(GETDATE() AS DATE)), DATEADD(day, 1, CAST(GETDATE() AS DATE)), '09:00:00', '09:30:00', 'Chequeo general', NULL, 1, 1, 'Control', 0),
            
-- Turno 2: Paciente 2 (Martinez) con Medico 2 (Fernandez - Derma)
(1, DATEADD(day, 2, CAST(GETDATE() AS DATE)), DATEADD(day, 2, CAST(GETDATE() AS DATE)), '15:00:00', '15:30:00', 'Consulta por erupción', NULL, 2, 2, 'Consulta', 0),

-- Turno 3: Paciente 3 (Lopez) con Medico 4 (Ruiz - Trauma) - Pasado (Completado)
(1, DATEADD(day, -5, CAST(GETDATE() AS DATE)), DATEADD(day, -5, CAST(GETDATE() AS DATE)), '10:30:00', '11:00:00', 'Dolor de rodilla', 'Reposo y antiinflamatorios', 4, 3, 'Urgencia', 1),
            
-- Turno 4: Paciente 4 (Rodriguez) con Medico 3 (Alvarez - Pedia)
(2, DATEADD(day, 1, CAST(GETDATE() AS DATE)), DATEADD(day, 1, CAST(GETDATE() AS DATE)), '11:00:00', '11:30:00', 'Control pediátrico', NULL, 3, 4, 'Control', 0);
GO
